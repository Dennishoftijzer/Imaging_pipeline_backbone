"""
This file contains concrete products for the 2D pipeline. These have not been implemented yet.
Concrete Products are created by corresponding Concrete Factories (ConcreteFactory_2D in Pipeline_factories.py).
...
class Acquisition_2D(Acquisition):
...
class Preprocess_2D(Preprocess):
    def __init__(self) -> None:
        # Setup logger
        self.logger = logging.getLogger(__name__)
...
class Enrichment_2D(Enrichment):
    def __init__(self) -> None:
        # Setup logger
        self.logger = logging.getLogger(__name__)
...
class DefectDetection_2D(DefectDetection):
    def __init__(self) -> None:
        # Setup logger
        self.logger = logging.getLogger(__name__)
